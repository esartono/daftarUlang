    ...
    <div>
        ...
        <table style="font-size: 90%; width: 100%">
            <tr>
                ...
                <td align="right">Depok, 15 Juni 2021<br>&nbsp;<br>&nbsp;</td>
            </tr>
        </table>
        <p>Yang kami hormati,</p>
        <br>
        Bapak/Ibu Orang tua siswa dari <b>{{ $d['nama'] }}</b><br>
        Kelas <b>{{ $d['kelas'] }}</b> SMAIT Nurul Fikri<br>
        di tempat
        <br>
        <br>
        ...
        <ol>
            ...
            <table class="biodata">
                <tr>
                    ...
                    <th colspan="2" width="20%">Jumlah</th>
            ...
            <li>
                Konfirmasi daftar ulang melalui Google Form <a href="https://forms.gle/f828VDbb3twmn2Aa8">https://forms.gle/f828VDbb3twmn2Aa8</a>
            </li>
            <li>
        ...
        <table class="ttd">
            <tr>
                ...
                <td>
                    Kepala Unit<br>
                    SMAIT Nurul Fikri<br>
                    <br>
                    <img class="cap" src="img/ttd-SMA.png" alt="stempel" height="60" width="auto" style="margin-bottom: -10px;"></img><br>
                    Mohammad Furqon
                </td>
            </tr>
        </table>
