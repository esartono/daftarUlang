...
@section('isi')
    <div>
        ...
        Kelas <b>{{ $d['kelas'] }}</b> SMPIT Nurul Fikri<br>
        di tempat
        <br>
        <br>
        ...
        <table class="ttd">
            <tr>
                ...
                <td>
                    Kepala Unit<br>
                    SMPIT Nurul Fikri<br>
                    <img class="cap" src="img/ttd-SMP.png" alt="stempel" height="100" width="auto" style="margin-bottom: -10px;"></img><br>
                    Teddy Azra
                </td>
            </tr>
        </table>
