...
@section('isi')
    <div>
        ...
        Kelas <b>{{ $d['kelas'] }}</b> TKIT Nurul Fikri<br>
        di tempat
        <br>
        <br>
        ...
        <ol>
            ...
            <table class="biodata">
                ...
                <tr>
                    ...
                    <td align="right"> - </td>
                    <td>Daftar Ulang TP 2021/2022</td>
                </tr>
                <tr>
                    <th> 2 </th>
                ...
                <tr>
                    ...
                    <td>SPP Juli 2021</td>
                    <td style="border-right: solid 1px #FFF;"> Rp. </td>
                    <td align="right">{{ number_format($d['ket']['SPP Juli21']) }}</td>
            ...
            <li>
                Konfirmasi daftar ulang melalui Google Form https://forms.gle/f828VDbb3twmn2Aa8
            </li>
            <li>
        ...
        <table class="ttd">
            <tr>
                ...
                <td>
                    ...
                    TKIT Nurul Fikri<br>
                    <br>
                    <img class="cap" src="img/ttd-TK.png" alt="stempel" height="55" width="auto"></img><br>
                    <br>
                    Muji Rahayu
                </td>
            </tr>
